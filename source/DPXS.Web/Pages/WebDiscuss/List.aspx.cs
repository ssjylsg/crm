...
namespace WebCrm.Web.Pages.WebDiscuss
{
    ...
    public partial class List : BasePage
    {
        ...
        public IDiscussCustomerRecordService Service
        {
            get { return DependencyResolver.Resolver<IDiscussCustomerRecordService>(); }
        }
        ...
        {
            PageQuery<IDictionary<string, object>, DiscussCustomerRecord> pageQuery = new PageQuery<IDictionary<string, object>, DiscussCustomerRecord>(this.CurrentOperatorUser);
