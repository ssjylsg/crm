<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs"
    Inherits="WebCrm.Web.Pages.WebDiscuss.List" %>
                        ...
                        <asp:Repeater ID="rptList" runat="server" OnItemCommand="rpt_cmd">
                            <ItemTemplate>
                                <tr class="tr_cur">
                                    ...
                                    <td class="td_1">
                                        <%#Eval("BussinessPerson.RealName")%>
                                    </td>
                                 
                                    <td class="td_1">
                                        <%#DateTime.Parse(Eval("DiscussDate").ToString()).ToShortDateString()%>
                                    </td>
                                    <td class="td_1" title='<%#Eval("OtherPersonName")%>'>
                                        <%#(Eval("OtherPersonName").ToString().Length > 10 ? Eval("OtherPersonName").ToString().Substring(0, 10) + "..." : Eval("OtherPersonName").ToString())%>
                                    </td>
                                       <td class="td_1">
                                     <%#Eval("State.Name")%>
                                    </td>
