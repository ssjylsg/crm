<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewOrEdit.aspx.cs" Inherits="WebCX.Web.Pages.WebCategoryItem.NewOrEdit" %>
                         ...
                         <tr>
                          ...
                          <tr>
                            ...
                            <td class="table_l_td">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="*请填写联系电话"
                        ...
                        <tr>
                         ...
                         <tr>
                            ...
                            <td class="table_l_td">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ErrorMessage="*请填写排序"
                                    ControlToValidate="DeptNameID" ForeColor="Red"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
