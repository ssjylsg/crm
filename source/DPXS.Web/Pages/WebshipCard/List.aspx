<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebCX.Web.Pages.WebshipCard.List" %>
                        ...
                        <asp:Repeater ID="rptList" runat="server" OnItemCommand="rpt_cmd">
                            <ItemTemplate>
                                <tr class="tr_cur">
                                    ...
                                    <td class="td_1">
                                        <%#DateTime.Parse(Eval("ValidDate").ToString()).ToShortDateString()%>
                                    </td>
                                    <td class="td_1" title='<%#Eval("Description")%>'>
                                        <%#Eval("Description").ToString().ToShortString()%>
                                    </td>
                                    <td class="td_1">
