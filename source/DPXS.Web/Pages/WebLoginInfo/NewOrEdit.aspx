<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewOrEdit.aspx.cs" Inherits="WebCX.Web.Pages.WebLoginInfo.NewOrEdit" %>
            ...
            <div class="r_content">
                <div class="tableNav_2">
                    ...
                    <tr>
                            ...
                            <td class="table_l_td">
                             <asp:DropDownList ID="CompanyId" runat="server" CssClass="input_1" Width="200px"></asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td width="90" align="right" class="table_l_tit">
