...
namespace WebCX.Web.Pages.WebDept
{
    public partial class List : BasePage
    {
        ...
        private List<TreeNode> GetFirstTree(int? parentId = 0, string comanyName = null)
        {
            ...
            IList<Department> list = this.Service.GetDeptServiceList(comanyName, parentId);
            return list.Select(m => new TreeNode() { Text = m.DeptName, Value = m.Id.ToString() }).ToList();
        }
