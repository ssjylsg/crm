<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebCX.Web.Pages.WebHoliday.List" %>
                ...
                <div class="tableNav">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="item_list">
                        <tr>
                            ...
                            <td align="left" class="table_title"  width="120">
                                日期
                            </td>
                        ...
                        <asp:Repeater ID="rptList" runat="server" OnItemCommand="rpt_cmd">
                            <ItemTemplate>
                                <tr class="tr_cur">
                                    ...
                                    <td class="td_1">
                                        <%#Eval("HolidayDate").ToShortDate()%>
                                    </td>
                                      <td class="td_1">
                                        <%#Eval("Name")%>
                                    </td>
                                      <td class="td_1">
                                        <%#Eval("IsSendMsg").ToString() == "True" ? "是":"否"%>
                                    </td>
                                    <td class="td_1">
                                        <%#Eval("Descript")%>
                                    </td>                                  
