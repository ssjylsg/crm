<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebCX.Web.Pages.WebAd.List" %>
                        ...
                        <asp:Repeater ID="rptList" runat="server" OnItemCommand="rpt_cmd">
                            <ItemTemplate>
                                <tr class="tr_cur">
                                    ...
                                    <td class="td_1">
                                        <%#DateTime.Parse(Eval("DeliveryDate").ToString()).ToShortDateString()%>
                                    </td>
