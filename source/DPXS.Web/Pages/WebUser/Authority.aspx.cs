...
namespace WebCX.Web.Pages.WebUser
{
    public partial class Authority : BasePage
    {
        ...
        public OperatorUser CurrentRole
        {
            get { return this.UserInfoService.FindById(this.Id); }
        }
        ...
        public void BindUserTreeData()
        {
            ...
            root.Text = "角色列表";
            root.Value = "0";
            root.ChildNodes.AddReage(AspNetHelper.GetRoleTreeNote(this.CurrentOperatorUser,
                                                                  this.RolePlugService.GetRoles(this.CurrentOperatorUser))
                                         .ToList());
