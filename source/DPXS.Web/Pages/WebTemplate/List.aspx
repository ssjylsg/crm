<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebCX.Web.Pages.WebTemplate.List" %>
                        ...
                        <asp:Repeater ID="rptList" runat="server" OnItemCommand="rpt_cmd">
                            <ItemTemplate>
                                <tr class="tr_cur">
                                    ...
                                    <td class="td_1" title='<%#Eval("MsgContent") %>'>
                                        <%#Eval("TemplateName")%>
                                    </td>
                                    <td class="td_1">
                                        <%#Eval("TemplateCode")%>
                                    ...
                                    <td class="td_1">
                                        <%#Eval("CreatePerson.OperatorName")%>
                                    </td>
                                    <td class="td_1">
                                        <%#Eval("MsgType.Name")%>
                                    </td>
