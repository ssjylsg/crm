...
namespace WebCX.Web.Pages.WebTemplate
{
    public partial class List : BasePage
    {
        ...
        public ITemplateService UserInfoService
        {
            get { return DependencyResolver.Resolver<ITemplateService>(); }
        }
        /// <summary>
        /// 绑定列表
        /// </summary>
        ...
        {
            var pageQuery = new PageQuery<IDictionary<string, object>, Template>(CurrentOperatorUser);
            pageQuery.Condition = new Dictionary<string, object>();

            if (!string.IsNullOrEmpty(txtQueryText.Text))
            {
                pageQuery.Condition.Add("TemplateName", txtQueryText.Text);
            }
