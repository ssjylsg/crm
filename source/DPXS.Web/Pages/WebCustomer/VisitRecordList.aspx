<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VisitRecordList.aspx.cs"
    Inherits="WebCrm.Web.Pages.WebCustomer.VisitRecordList" %>
            ...
            <div class="r_content">
                <div class="tableNav">
                    <div class="tool_search">
                        <input type="button" class="btn02 page_btnAdd" value="新增" onclick="location.href='VisitRecord.aspx?CustomerId=<%=Request.QueryString["CustomerId"] %>'" />
                        ...
                        <asp:Repeater ID="rptList" runat="server" OnItemCommand="rpt_cmd">
                            <ItemTemplate>
                                <tr class="tr_cur">
                                    ...
                                    <td class="td_1">
                                        <%#Eval("BusinessPeople.RealName")%>
                                    </td>
                                    <td class="td_1">
                                        <%#DateTime.Parse(Eval("VisitDate").ToString()).ToShortDateString()%>
                                    </td>
                                    <td class="td_1" title='<%#Eval("OtherPerson")%>'>
                                        <%#(Eval("OtherPerson").ToString().Length > 10 ? Eval("OtherPerson").ToString().Substring(0, 10) + "..." : Eval("OtherPerson").ToString())%>
                                    </td>
                                    ...
                                    <td class="td_1">
                                        ...
                                        <a href="VisitRecord.aspx?NE=edit&Id=<%#Eval("Id") %>">编辑</a>
