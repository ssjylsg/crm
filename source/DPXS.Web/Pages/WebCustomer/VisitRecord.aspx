<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VisitRecord.aspx.cs" Inherits="WebCrm.Web.Pages.WebCustomer.VisitRecord" %>
    ...
    <div class="rightArea">
        <div class="r_ContentNav">
            <div class="r_tit1">
                <ul>
                    <li>
                        <asp:Label ID="lblTitle" runat="server" Text="回访记录"></asp:Label>：
            ...
            <div class="r_content">
                ...
                <div class="tool_2">
                    ...
                    <input type="button" class="btn02 page_btnBack" value="返回" onclick="location.href='VisitRecordList.aspx'" />
                </div>
            </div>
        </div>
    </div>
