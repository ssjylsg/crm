<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebCX.Web.Pages.WebComapny.List" %>
        ...
        <div class="r_ContentNav">
            ...
            <div class="r_content">
                <div class="tool_search">
                    ...
                    <asp:Button ID="btnDelete" runat="server" class="btn02 page_btnDelete" Text="删除"
                        OnClientClick="return confirm('确认删除？')" Enabled="false" OnClick="btnDelete_Click" />
