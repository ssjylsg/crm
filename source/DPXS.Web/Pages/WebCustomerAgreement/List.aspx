<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebCX.Web.Pages.WebCustomerAgreement.List" %>
                        ...
                        <asp:Repeater ID="rptList" runat="server" OnItemCommand="rpt_cmd">
                            <ItemTemplate>
                                <tr class="tr_cur">
                                    ...
                                    <td class="td_1">
                                        <%#Eval("AgreementType.Name")%>
                                    </td>
                                    <td class="td_1">
                                        <%#Eval("Expire").ToShortDate()%>
                                    </td>
                                    <td class="td_1">
