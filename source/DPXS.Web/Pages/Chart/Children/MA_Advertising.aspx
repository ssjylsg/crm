<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MA_Advertising.aspx.cs"
    Inherits="WebCrm.Web.Pages.Chart.Children.MA_Advertising" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>市场活动分析->广告效果分析</title>
            ...
            <td valign="top">
                <table class="controls" cellpadding="4">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:CheckBox ID="CheckboxShow3D" runat="server" AutoPostBack="True" Text="" Checked="false">
                            </asp:CheckBox>
                        </td>
                    </tr>
                </table>
