<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalesPerformance.aspx.cs"
    Inherits="WebCrm.Web.Pages.Chart.Children.SalesPerformance" %>
...
<body>
    ...
    <div class="tb_condition" style="margin-left:100px">
        消费记录录入开始日期：
        ...
        <input id="endDate" runat="Server" style="width: 95px; height: 18px;" type="text"
            ...
            部门:
            <asp:DropDownList ID="DeptID" runat="server" Width="150px"></asp:DropDownList>
        <asp:Button ID="btnQuery" runat="server" Text="查询" OnClick="btnQuery_Click" />
    </div>
    <table class="sampleTable" style="margin-left:100px">
        <tr>
                ...
                <asp:Chart ID="Chart1" runat="server" Palette="BrightPastel" BackColor="#F3DFC1"
                    ...
                    <ChartAreas>
                        <asp:ChartArea Name="ChartArea1" BorderColor="64, 64, 64, 64" BackSecondaryColor="White"
                            ...
                            <AxisY LineColor="64, 64, 64, 64" LabelAutoFitMaxFontSize="8" Title="营业额" TitleForeColor="26, 59, 105"
                                TitleFont="Trebuchet MS, 8pt, style=Bold">
                                <LabelStyle Font="Trebuchet MS, 8.25pt, style=Bold" />
                                <MajorGrid LineColor="64, 64, 64, 64" />
                            </AxisY>
                            <AxisX LineColor="64, 64, 64, 64" LabelAutoFitMaxFontSize="8" Title=" " TitleForeColor="26, 59, 105"
                                TitleFont="Trebuchet MS, 8pt, style=Bold">
