<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CA_CustomerCategory.aspx.cs"
    Inherits="WebCrm.Web.Pages.Chart.Children.CA_CustomerCategory" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>客户结构分析:客户类型</title>
...
<body>
    ...
    <div class="tb_condition">
        ...
        <asp:DropDownList ID="CustomerCategoryID" runat="server" AutoPostBack="true">
        </asp:DropDownList>
        <asp:Button ID="btnQuery" runat="server" Text="查询" OnClick="btnQuery_Click" />
    </div>
    <table class="sampleTable" style="width: 750px;">
        <tr>
            <td width="540px" class="tdchart">
                <asp:Chart ID="Chart1" runat="server" Palette="BrightPastel" BackColor="#F3DFC1"
                    Width="540px" Height="296px" BorderlineDashStyle="Solid" BackGradientStyle="TopBottom"
                    ...
                    <ChartAreas>
                        <asp:ChartArea Name="ChartArea1" BorderColor="64, 64, 64, 64" BackSecondaryColor="White"
                            ...
                            <AxisX LineColor="64, 64, 64, 64" LabelAutoFitMaxFontSize="8" Title="区域" TitleForeColor="26, 59, 105"
                                TitleFont="Trebuchet MS, 8pt, style=Bold">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="DrawingStyle" runat="server" Width="120px" AutoPostBack="True"
                                ...
                                <asp:ListItem Value="Cylinder" Selected="True">圆柱体</asp:ListItem>
