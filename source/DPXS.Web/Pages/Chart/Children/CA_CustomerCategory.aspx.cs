...
{
    public partial class CA_CustomerCategory : BasePage
    {
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            if (ChartType.SelectedValue == "Bar")
            {
                ...
                Chart1.Titles[0].Text = "客户类型分布条形图";
            }
            else
            {
                Chart1.Series["Series1"].ChartType = SeriesChartType.Column;
                Chart1.Titles[0].Text = "客户类型分布柱形图";
            }
        ...
        public DataTable GetStatisticsData()
        {
            ...
            dict.Add("CategoryID", CustomerCategoryID.SelectedValue);
            dict.Add("CompanyId", this.CurrentCompany != null ? this.CurrentCompany.Id : 0);
            return DependencyResolver.Resolver<IChartService>().GetCustomerCategory(dict);
        }
    }
}