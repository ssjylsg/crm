...
FCKConfig.ToolbarSets["Default"] = [
	['Source','-','FontName','FontSize','Bold','Italic','Underline','-','TextColor','BGColor','FitWindow'],
	'/',
	['Undo','Redo','-','Find','Replace','RemoveFormat','-','OrderedList','UnorderedList','-','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','-','Link','Unlink','Anchor','-','Image','Table','Rule','SpecialChar','PageBreak']
] ;

FCKConfig.ToolbarSets["Basic"] = [
	['Source','FontSize','Bold','Italic','Underline','TextColor']
] ;
...
FCKConfig.FontSizes		= 'larger;small;medium;large;x-large;xx-large' ;
